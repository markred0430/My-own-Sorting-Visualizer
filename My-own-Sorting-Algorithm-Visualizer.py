...
generate.grid(padx=15, pady=15, row=0, column=0, sticky='WE')
start.grid(padx=15, pady=15, row=1, column=0, sticky='WE')
exit.grid(padx=15, pady=15, row=2, column=0, sticky='WE')
